...
<head>
    ...
    <meta name="description" content="Oefen in het Spaans hoe je aan de kaartverkoop van Atocha een retourticket naar Toledo regelt.">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>En la estación · Spaansspreken.nl</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bakery-body station-body">
    <a href="#dialogue-content" class="hub-skip-link">Ga naar het gesprek met Nuria</a>
    ...
    <div
        ...
        data-scenario-slug="station-nuria"
    ...
    >
        ...
        <main id="dialogue-content" class="bakery-main">
            <section class="bakery-heading" aria-labelledby="station-title">
                <div>
                    <p class="bakery-eyebrow">Dag 6 · Madrid · Estación de Atocha</p>
                    <h1 id="station-title" data-mission-title>Mijn eerste treinkaartje</h1>
            ...
            <section class="bakery-stage" data-dialogue-stage hidden>
                <aside class="bakery-scene station-scene" aria-label="De lichte stationshal en kaartverkoop van Atocha">
                    <div class="station-roof" aria-hidden="true"><span></span><span></span><span></span></div>
                    <div class="station-board" aria-hidden="true">
                        <strong>SALIDAS</strong>
                        <span>09:00 · TOLEDO · VÍA 6</span>
                        <span>10:20 · TOLEDO · VÍA 4</span>
                    </div>
                    <div class="station-clock" aria-hidden="true"><i></i><b></b></div>
                    <div class="station-train" aria-hidden="true"><span></span><i></i><i></i><i></i></div>
                    <div class="station-counter" aria-hidden="true"><span>BILLETES</span></div>
                    <div class="bakery-npc-card station-npc-card">
                        <span class="bakery-npc-avatar station-avatar" aria-hidden="true">N</span>
                        <div>
                            <strong data-npc-name>Nuria Martín</strong>
                            <span><span lang="es" data-npc-role-es>agente de venta</span> · <span data-npc-role-nl>baliemedewerker</span></span>
                        </div>
                    </div>
                </aside>
                ...
                <div class="bakery-dialogue-column">
                    <section class="bakery-conversation" aria-labelledby="conversation-title">
                        <div class="bakery-turn-heading">
                            <div><p class="bakery-eyebrow">Nuria zegt</p><h2 id="conversation-title">Jij bent aan de beurt</h2></div>
                        ...
                        <button type="button" class="bakery-continue-button" data-dialogue-continue hidden>Verder met je reis <span aria-hidden="true">→</span></button>
                    </section>

                    <aside class="bakery-history" aria-labelledby="station-history-title">
                        <div><p class="bakery-eyebrow">Gespreksverloop</p><h2 id="station-history-title">Wat je al hebt gezegd</h2></div>
                        <ol data-dialogue-history><li data-history-empty>Nog geen antwoorden. Nuria wacht rustig op je.</li></ol>
                    </aside>
                </div>
            </section>

            <section class="bakery-level-select" data-level-select aria-labelledby="station-level-title" hidden>
                <p class="bakery-eyebrow">Voor je naar de kaartverkoop gaat</p>
                <h2 id="station-level-title">Hoeveel steun wil je?</h2>
                <p>Dit bepaalt alleen welke onverwachte reisvraag Nuria stelt. Je formuleert ieder antwoord zelf; voorbeeldzinnen blijven optionele hulp.</p>
                <div>
                    <button type="button" data-level="A0"><strong>A0 · Veel steun</strong><span>Nuria vraagt alleen of je een retourticket wilt.</span></button>
                    <button type="button" data-level="A1"><strong>A1 · Een beetje steun</strong><span>De gekozen trein is vol en je reageert op een alternatief.</span></button>
                    <button type="button" data-level="A2"><strong>A2 · Zelf proberen</strong><span>Je controleert de voorwaarden van een flexibel tarief.</span></button>
                </div>
            </section>

            <section class="bakery-complete station-complete" data-dialogue-complete hidden tabindex="-1" aria-labelledby="station-complete-title">
                <div class="bakery-stamp" aria-hidden="true">✓</div>
                <p class="bakery-eyebrow">Dag 6 voltooid</p>
                <h2 id="station-complete-title">¡Buen viaje!</h2>
                ...
                <div class="station-ticket" aria-label="Virtueel retourticket naar Toledo">
                    <span>IDA Y VUELTA</span><strong>MADRID → TOLEDO</strong><small>Je nieuwe verzamelitem</small>
                </div>
            ...
            <section class="bakery-error" data-dialogue-error hidden aria-labelledby="station-error-title">
                ...
                <h2 id="station-error-title">Nuria kan je ticket nog niet regelen</h2>
                <p>Publiceer het gespreksscenario <strong>station-nuria</strong> via een productierelease om dag 6 te openen.</p>
