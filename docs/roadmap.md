...
- **3B4 — station:** treinreis regelen via dezelfde herbruikbare Content Studio- en gespreksmotor.
- **3B5 — speelcontentbouwer en preview:** typespecifieke wereld-, NPC- en gesprekseditor, diepe routevalidatie, mediabeheer en een voortgangsvrije spelpreview.
- **3B6 — visuele gouden route:** echte scène- en personage-assets, reacties, beloningspresentatie en één volledig geteste Madrid → La Espiga-spelersreis.
