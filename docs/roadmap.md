...
- **3B2.5 — demo-ready Content Studio (gerealiseerd):** risicogestuurde zelfgoedkeuring voor gewone content, onafhankelijke review voor gevoelige content, veilige reviewintrekking, inhoudelijke speelbaarheidscontrole en een uitbreidbaar idempotent conceptpakket; fase 3C2 bevat zeven voorbeeldrecords.
