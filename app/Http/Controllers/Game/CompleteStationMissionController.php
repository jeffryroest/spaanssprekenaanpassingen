...
use App\Actions\PlayerProgress\CompleteStationMission;
...
final class CompleteStationMissionController extends Controller
{
    public function __invoke(
        CompletePanaderiaMissionRequest $request,
        CompleteStationMission $completeMission,
    ): JsonResponse {
        try {
