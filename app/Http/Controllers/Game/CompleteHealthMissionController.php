...
use App\Actions\PlayerProgress\CompleteHealthMission;
...
final class CompleteHealthMissionController extends Controller
{
    public function __invoke(
        CompletePanaderiaMissionRequest $request,
        CompleteHealthMission $completeMission,
    ): JsonResponse {
        try {
