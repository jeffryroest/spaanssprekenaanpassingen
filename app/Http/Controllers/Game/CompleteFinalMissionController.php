...
use App\Actions\PlayerProgress\CompleteFinalMission;
...
final class CompleteFinalMissionController extends Controller
{
    public function __invoke(
        CompletePanaderiaMissionRequest $request,
        CompleteFinalMission $completeMission,
    ): JsonResponse {
        try {
        ...
        return response()->json([
            ...
            'meta' => [
                ...
                'memory_source' => 'completed_missions_only',
            ],
        ]);
    }
}
