...
use App\Actions\PlayerProgress\CompleteRestaurantMission;
...
final class CompleteRestaurantMissionController extends Controller
{
    public function __invoke(
        CompletePanaderiaMissionRequest $request,
        CompleteRestaurantMission $completeMission,
    ): JsonResponse {
        try {
